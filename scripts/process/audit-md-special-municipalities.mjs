...
const results=ids.map(id=>{
 ...
 const diagnostic_class=id==='0300'?'municipality_uat_with_parallel_independently_maintained_city_boundaries':'municipality_uat_with_city_locality';
 const roles=levels.map(r=>({...r,representation_role:r.admin_level==='4'?'municipality_uat':id==='0300'?'parallel_city_boundary':'city_locality'}));
 ...
 const representation_review=id==='0300'?{classification:'parallel_independently_maintained_city_boundaries',canonical_city_relation_id:null,evidence:{intersection_over_smaller:baltiGeometry.comparisons.city_candidates.intersection_over_smaller,intersection_over_union:baltiGeometry.comparisons.city_candidates.intersection_over_union,symmetric_difference_km2:baltiGeometry.comparisons.city_candidates.symmetric_difference_km2,shared_current_way_count:baltiWays.current_way_membership.shared.length,relation_12207955_current_way_count:baltiWays.current_way_membership.only_12207955.length,relation_18967626_current_way_count:baltiWays.current_way_membership.only_18967626.length},next_review:'Resolve semantic/source intent from OSM changesets/tags before any canonical city-boundary selection.'}:null;
